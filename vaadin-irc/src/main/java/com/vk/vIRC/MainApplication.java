...
//
//	public static final Boolean isLightWeight = Boolean.TRUE;
//
...
//					mainWindow.addComponent(pusher);
//					this.getContext();
//					if (MainApplication.isLightWeight) {
//						if (transactionData instanceof HttpServletRequest) {
//							this.remoteAddress = resolveRemoteHost((HttpServletRequest) transactionData);
//						}
//
//						LightweightLoginView llv = (LightweightLoginView) mainLayout.setCurrentView(LightweightLoginView.class); // login
//					} else {
//						mainLayout.setCurrentView(new LoginView().getClass());
//					}
...
//			System.out
//			.println("Looks like there were no connection in the first place...");
//		}
//		setUser(null);
//		if (current != null) {
//			current.set(null);
...
//	}
//
//	public TabFactory getTabManager() {
//		TabFactory tm = new TabFactory();
//		IRCView iv = (IRCView) mainLayout.getAbstractView(IRCView.class);
//		tm.setIrcView(iv);
//		return tm;
//	}
//
